...
class TestCSVViews:
    ...
    def test_csv_import(self, client, admin_user, csv_data):
        ...
        csv_file = SimpleUploadedFile('projects.csv', csv_data['projects'], content_type='text/csv')
        ...
        csv_file = SimpleUploadedFile('suites.csv', csv_data['suites'], content_type='text/csv')
        response = client.post(url, {'file': csv_file})
        assert response.status_code == 200
        ...
        csv_file = SimpleUploadedFile('cases.csv', csv_data['cases'], content_type='text/csv')
        response = client.post(url, {'file': csv_file})
        assert response.status_code == 200
        ...
        csv_file = SimpleUploadedFile('steps.csv', csv_data['steps'], content_type='text/csv')
        response = client.post(url, {'file': csv_file})
        assert response.status_code == 200
    ...
    def test_csv_import_invalid_type(self, client, admin_user):
        ...
        csv_file = SimpleUploadedFile('invalid.csv', b'invalid data', content_type='text/csv')
        response = client.post(url, {'file': csv_file})
